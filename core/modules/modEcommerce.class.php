...
class modEcommerce extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		*/
		...
		/* BEGIN MODULEBUILDER TOPMENU */
                $this->menu[$r++] = array(
                        ...
                        'mainmenu' => 'ecommerce',
                        'leftmenu' => '',
                        'url' => '/custom/ecommerce/ecommerceindex.php',
                ...
                // Link to the image scraper page
                $this->menu[$r++] = array(
                        'fk_menu' => 'fk_mainmenu=ecommerce',
                        'type' => 'left',
                        'titre' => 'ImageScraper',
                        'mainmenu' => 'ecommerce',
                        'leftmenu' => 'imagescraper',
                        'url' => '/custom/ecommerce/scraper.php',
                        'langs' => 'ecommerce@ecommerce',
                        'position' => 1000 + $r,
                        'enabled' => "isModEnabled('ecommerce')",
                        'perms' => '1',
                        'target' => '',
                        'user' => 2,
                );
		...
		*/
		...
		$this->export_sql_end[$r]  =' FROM '.MAIN_DB_PREFIX.'test_myobject as t';
		//$this->export_sql_end[$r]  .=' LEFT JOIN '.MAIN_DB_PREFIX.'test_myobject_line as tl ON tl.fk_myobject = t.rowid';
